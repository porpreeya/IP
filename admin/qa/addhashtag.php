...
margin-left and margin-right + width = 100%*/
    ...
    <h2 class="glow">เพิ่มเเฮชเเท็ก</h2><br><br>
...
<div class="tb">
    ...
    <div class="box2">
        <form action="qa/storhashtag.php" method="post" enctype="multipart/form-data" class="form">
            <table class="center">
                <tr class="tr">
            ...
            <table style="width:80%" class="center">
                <tr><br><br><br>
                    <th style="font-size:18px;">เพิ่มเเฮชเเท็กคำถาม</th>
                </tr>
                <tr class="tr">
                    <td><br>
                        <div class="container">
                            <input type="text" id="text" class="width:100% " placeholder="#...." name="hashtag" required>
                    </td>
