    ...
    <div class="box2">
        <!-- //ไอดีที่เราทำการดึงมาเพื่อนำมาแก้ไข -->
           <?php $ID = $_GET['ID'];
            ...
            $data = mssql_query("SELECT * FROM tb_hashtag WHERE ID='$ID'")
                or die(mssql_error());
            ...
            ?>
        <form action="qa/updatehashtag.php?ID=<?php echo $info['ID']; ?>" method="post" enctype="multipart/form-data" class="form">
            <table class="center">
                <tr class="tr">
            ...
            <tr><br><br><br>
                    <th style="font-size:18px;">แก้ไขเเฮชเเท็กคำถาม</th>
                </tr>
                <tr class="tr">
                    <td><br>
                        <div class="container">
                        <input type="text" id="text" class="width:100% " placeholder="#...." name="hashtag" required value="<?php echo $hashtag; ?>">
                    </td>
