...
<body>
    ...
    <a onclick="location. href='indexadmin.php?Menu=4&Submenu=showqa';">
        <p class="outset1">ย้อนกลับ</p>
    </a>
    <a  onclick="location. href='indexadmin.php?Menu=4&Submenu=addhashtag';">
        <p class="outset">เพิ่มเเฮชเเท็ก</p>
    </a><br><br>
    <table class="center">
        <tr>
            <th>ลำดับ</th>
            <th class="th">แฮชเเท็ก</th>
            <th>แก้ไขข้อมูล </th>
            <th>ลบข้อมูล </th>
        ...
        ?>
            <tr>
                ...
                <td style="text-align:center ;"><a href='indexadmin.php?Menu=4&Submenu=edithashtag&ID=<?php echo $info['ID']; ?>'><button type="button" class="btn btn-warning">Edit</button></a> </td>
                <td style="text-align:center ;"><a href='qa/deletehashtag.php?ID=<?php echo $info['ID']; ?>'><button type="button" class="btn btn-danger">delete</button></a></td>
