...
<body class="body">
  ...
  <?php $ID = $_GET['ID'];
            // $objDB = mssql_select_db("intelle");
            $data = mssql_query("SELECT * FROM tb_login WHERE ID='$ID'")
                or die(mssql_error());
          ...
          ?>
        <form action="loginadd/updatelog.php?ID=<?php echo $info['ID']; ?>" class="form" method="POST" enctype="multipart/form-data">
            <table style="width:80%" class="center">
                ...
                <tr class="tr">
                    <td>
                        <div class="container">
                            <input type="text" id="text" class="width:100% " placeholder="" name="firstname" required value="<?php echo $firstname; ?>">
                    </td>
                    <td>
                        <input type="text" id="text" class="width:100% " placeholder="" name="lastname" required value="<?php echo $lastname; ?>">
                    </td>
            ...
            <table style="width:80%" class="center">
                ...
                <tr class="tr">
                    <td>
                        <div class="container">
                            <input type="text" id="text" class="width:100% " placeholder="" name="useradd" required value="<?php echo $useradd; ?>">
                    </td>
                    <td>
                        <input type="text" id="text" class="width:100% " placeholder="" name="password" required value="<?php echo $password; ?>">
                    </td>
